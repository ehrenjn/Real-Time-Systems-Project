// Taken directly from the CU Learn sample code "SimpleEchoClient.java"
...
public class SchedulerRPCReceiver {

DatagramPacket sendPacket, receivePacket;
DatagramSocket sendReceiveSocket;

public SchedulerRPCReceiver()
{
   try {
...
{
   SchedulerRPCReceiver c = new SchedulerRPCReceiver();
   c.sendAndReceive();
}
}
