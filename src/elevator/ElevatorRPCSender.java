// Taken directly from the CU Learn sample code "SimpleEchoServer.java"
...
public class ElevatorRPCSender {

   DatagramPacket sendPacket, receivePacket;
   DatagramSocket sendSocket, receiveSocket;

   public ElevatorRPCSender()
   {
      try {
   ...
   {
	   ElevatorRPCSender c = new ElevatorRPCSender();
      c.receiveAndEcho();
   }
}